...
options=odeset('Mass',M,'MassSingular','yes','RelTol',1e-3,'AbsTol',1e-6,'Vectorized','off','Stats','on','MaxOrder',5,'JPattern','on','OutputFcn',@odetpbar);
...
[t,y]=ode15s(@modeleqns_problem_2,0:0.01:5,Y0,options);
...
plot(t,y(:,N),'r-');
hold all
iptwindowalign(figure(1),'left',figure(2),'right');
toc